 ...
 *
 * <pre>{@code
 * sender = MyOkHttpSender.create("http://127.0.0.1:9411/api/v2/spans");
 * }</pre>
 *
 ...
 * sender = MyOkHttpSender.newBuilder()
 ...
 */
@Slf4j
public final class MyOkHttpSender extends Sender {

    /**
     * Creates a sender that posts {@link Encoding#JSON} messages.
     */
    public static MyOkHttpSender create(String endpoint) {
    ...
    public static final class Builder {
        ...
        public final MyOkHttpSender build() {
            return new MyOkHttpSender(this);
        }
    }
    ...
    MyOkHttpSender(Builder builder) {
        ...
        log.info("endpoint={};encoding={};client={};", endpoint, encoding, client);
    }
    ...
    static Dispatcher newDispatcher(int maxRequests) {
        ...
        ThreadPoolExecutor dispatchExecutor =
                new ThreadPoolExecutor(0, maxRequests, 60, TimeUnit.SECONDS,
                        ...
                        r -> new Thread(r, "MyOkHttpSender Dispatcher"));
    ...
    public zipkin2.Call<Void> sendSpans(List<byte[]> encodedSpans) {
        ...
        try {
            ...
            log.error("newRequest error!", e);
            throw Platform.get().uncheckedIOException(e);
        }
        HttpCall httpCall = new HttpCall(client.newCall(request));
        log.info("sendCall;client={};httpCall={};", client, httpCall);
        return httpCall;
    }
    ...
    public final String toString() {
        return "MyOkHttpSender{" + endpoint + "}";
    }
