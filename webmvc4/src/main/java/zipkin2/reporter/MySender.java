 ...
 */
public abstract class MySender extends Component {
    ...
    /**
     * Before invoking {@link MySender#sendSpans(List)}, callers must consider message overhead, which
     * might be more than encoding overhead. This is used to not exceed {@link
     * MySender#messageMaxBytes()}.
     *
