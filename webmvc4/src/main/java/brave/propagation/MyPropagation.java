 ...
 * @since 4.0
 */
public interface MyPropagation<K> {
    /**
     ...
     * @since 4.0
     */
    MyPropagation<String> B3_STRING = MyB3Propagation.get();
    /**
     * @deprecated Since 5.9, use {@link B3Propagation#newFactoryBuilder()} to control inject formats.
     */
    @Deprecated MyPropagation<String> B3_SINGLE_STRING = MyB3SinglePropagation.FACTORY.get();
    ...
    abstract class Factory {
         ...
         *
         * In usual <a href="https://github.com/openzipkin/b3-propagation">B3 MyPropagation</a>, the
         ...
         */
        @Deprecated
        public abstract <K> MyPropagation<K> create(KeyFactory<K> keyFactory);
    ...
    /**
     * Used as an input to {@link MyPropagation#injector(Setter)} inject the {@linkplain TraceContext
    ...
    /**
     * Used as an input to {@link MyPropagation#extractor(Getter)} extract the {@linkplain TraceContext
