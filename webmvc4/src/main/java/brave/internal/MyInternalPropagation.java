 ...
 */
public abstract class MyInternalPropagation {
    /**
     * A flags bitfield is used internally inside {@link MyTraceContext} as opposed to several booleans.
    ...
    public static MyInternalPropagation instance;
     ...
     */
    public abstract MyTraceContext newTraceContext(
            int flags,
            long traceIdHigh,
            long traceId,
            long localRootId,
     ...
     */
    public abstract MyTraceContext shallowCopy(MyTraceContext context);

    /** {@link brave.propagation.TraceContext} is immutable so you need to read the result */
    public abstract MyTraceContext withExtra(MyTraceContext context, List<Object> immutableExtra);

    /** {@link brave.propagation.TraceContext} is immutable so you need to read the result */
    public abstract MyTraceContext withFlags(MyTraceContext context, int flags);
}
