 ...
 */
@Slf4j
abstract class MyWebMvcRuntime {
    private static final MyWebMvcRuntime WEBMVC_RUNTIME = findWebMvcRuntime();
     ...
     */
    static MyWebMvcRuntime findWebMvcRuntime() {
    ...
    static final class WebMvc31 extends MyWebMvcRuntime {
        @Override
    ...
    static final class WebMvc25 extends MyWebMvcRuntime {
        @Override
        HttpTracing httpTracing(ApplicationContext ctx) {
