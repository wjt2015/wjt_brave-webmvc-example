...
/**
 * This provides utilities needed for trace instrumentation. For example, a {@link MyTracer}.
 *
 ...
 */
public abstract class  MyTracing implements Closeable {
    static final AtomicReference< MyTracing> CURRENT = new AtomicReference<>();
    ...
    abstract public MyTracer tracer();
     ...
     *
     * @see MyTracer#nextSpan(SamplerFunction, Object) for temporary overrides
     */
     ...
     */
    abstract public MyCurrentTraceContext currentTraceContext();
     ...
     */
    @Nullable public static  MyTracing current() {
        return CURRENT.get();
    }
     ...
     * <p>This object should not be cached.
     */
    @Nullable public static MyTracer currentTracer() {
         MyTracing tracing = current();
    ...
    public static final class Builder {
        ...
        MyCurrentTraceContext currentTraceContext = MyCurrentTraceContext.Default.inheritable();
         ...
         *
         * See {@link  MyTracing#clock(TraceContext)}
         */
        ...
        /**
         * Responsible for implementing {@link MyTracer#startScopedSpan(String)}, {@link
         * MyTracer#currentSpanCustomizer()}, {@link MyTracer#currentSpan()} and {@link
         * MyTracer#withSpanInScope(Span)}.
         *
         ...
         */
        public Builder currentTraceContext(MyCurrentTraceContext currentTraceContext) {
         ...
         * To see which code was involved, set this and ensure the logger {@link  MyTracing} is at {@link
    ...
    static final class Default extends  MyTracing {
        final MyTracer tracer;
        ...
        @Override public MyTracer tracer() {
            return tracer;
        }
        ...
        @Override public MyCurrentTraceContext currentTraceContext() {
     ...
     MyTracing() { // intentionally hidden constructor
    }
}
