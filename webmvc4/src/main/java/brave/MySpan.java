 ...
 * MySpan span = tracer.nextSpan().name("encode").start();
 ...
 *
 * <h3>Usage notes</h3>
 * All methods return {@linkplain MySpan} for chaining, but the instance is always the same. Also,
...
public abstract class MySpan implements SpanCustomizer {
    public enum Kind {
        CLIENT,
        SERVER,
        /**
     ...
     */
    public abstract MySpan start(long timestamp);

    /** {@inheritDoc} */
    @Override public abstract MySpan name(String name);
     ...
     */
    public abstract MySpan kind(@Nullable Kind kind);

    /** {@inheritDoc} */
    @Override public abstract MySpan annotate(String value);
     ...
     * use this, generate the timestamp using {@link Tracing#clock(TraceContext)}.
     */
    public abstract MySpan annotate(long timestamp, String value);

    /** {@inheritDoc} */
    @Override public abstract MySpan tag(String key, String value);
    ...
    public abstract MySpan error(Throwable throwable);

    /**
     * @deprecated Since 5.0, use {@link #remoteServiceName(String)} {@link #remoteIpAndPort(String,
     * int)}.
     */
    @Deprecated public MySpan remoteEndpoint(Endpoint endpoint) {
     ...
     */
    public abstract MySpan remoteServiceName(String remoteServiceName);
     ...
     * as zero.
     *
     * <p>This returns boolean, not MySpan as it is often the case strings are malformed. Using this,
    ...
    MySpan() { // intentionally hidden constructor
    }
}
